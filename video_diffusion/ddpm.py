...
from video_diffusion.scheduler import NoiseScheduler
...
class GaussianDiffusion_DDPM(DiffusionModel):
    ...
    def sample(
        ...
        shape = (
            ...
            self._config.diffusion.sampling.params.output_frames,
    ...
    def print_model_summary(self):
        ...
        summary_context = {
            "timestep": torch.randint(0, 10, size=(batch_size,), device=device),
        ...
        summary_context = self._context_preprocessor(summary_context, device=device)
    ...
    def load_checkpoint(self, checkpoint_path: str, full: bool = False):
